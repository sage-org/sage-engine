...
class LeftJoinIterator(PreemptableIterator):
    ...
    def __init__(self, left: PreemptableIterator, right: PreemptableIterator, context: dict, current_mappings: Optional[Dict[str, str]] = None):
        super(LeftJoinIterator, self).__init__()
        self._left = left
        self._right = right
        self._current_mappings = current_mappings

    def __repr__(self) -> str:
        return f"<LeftJoinIterator ({self._left} LeftJOIN {self._right} WITH {self._current_mappings})>"
