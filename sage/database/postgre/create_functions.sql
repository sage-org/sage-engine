...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE subject = $2 AND predicate = $3 AND object = $4;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE (subject, predicate, object) >= ($2, $3, $4);
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE subject = $2;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE subject = $2 AND (predicate, object) >= ($3, $4);
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE predicate = $2 ORDER BY subject, object;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE predicate = $3 AND (subject, object) >= ($2, $4) ORDER BY subject, object;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE object = $2 ORDER BY subject, predicate;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE object = $4 AND (subject, predicate) >= ($2, $3) ORDER BY subject, predicate;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE subject = $2 AND predicate = $3;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE predicate = $2 AND object = $3;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE predicate = $3 AND object = $4 AND (subject) >= ($2);
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE subject = $2 AND object = $3;
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    OPEN $1 FOR SELECT * FROM watdiv WHERE subject = $2 AND object = $4 AND (predicate) >= ($3);
    RETURN $1;
END;
$$ LANGUAGE plpgsql;
