...
from sage.database.backends.hbase.iterator import HBaseIterator
from sage.database.backends.hbase.utils import build_row_key
from sage.database.backends.estimators import pattern_shape_estimate
...
class HBaseConnector(DatabaseConnector):
    ...
    def search(self, subject: str, predicate: str, obj: str, last_read: Optional[str] = None, as_of: Optional[datetime] = None) -> Tuple[HBaseIterator, int]:
        ...
        card = pattern_shape_estimate(subject, predicate, obj)
